...
export function DeviceArrowIcon() {
  return (
...
export function DeviceClockIcon() {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" >
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
export function DeviceListIcon() {
  return (
...
export function DeviceLockIcon() {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" >
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
export function DeviceChartIcon() {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" >
      <path
        fillRule="evenodd"
